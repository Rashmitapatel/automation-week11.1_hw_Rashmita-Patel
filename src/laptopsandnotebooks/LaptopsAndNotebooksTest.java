...
public class LaptopsAndNotebooksTest extends Utility {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.xpath("//input[@id='input-payment-address-1']"), "gujarat");
        sendTextToElement(By.xpath("//input[@id='input-payment-city']"), "Surat");
        sendTextToElement(By.xpath("//input[@id='input-payment-postcode']"), "456123");
